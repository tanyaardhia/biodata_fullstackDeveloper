...
class AdminController {
  static async AdminGetDatabase(req, res, next) {
    try {
  ...
  static async updateDatabaseById(req, res, next) {
    try {
      const { id } = req.params;
      const {
        position,
  ...
  static async deleteDatabaseById(req, res, next) {
    try {
      const { id } = req.params;
  ...
  static async searchDatabaseByName(req, res, next) {
    try {
